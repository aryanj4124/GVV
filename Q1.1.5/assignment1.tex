...
\begin{align}
	\vec{m} &= \vec{B}-\vec{A}\\
         ...
         &= \myvec{-5\\7\\}
\end{align}
we have to find $\vec{n}^{\top}$ such that,
\begin{align}
           \implies \vec{n}^{\top}\vec{m} &= 0
\\         \implies \vec{n}^{\top} &= \myvec{7&5} 
\end{align}
normal form of equation of line AB:
\begin{align}
       \implies \vec{n}^{\top}(\vec{x} - \vec{A}) &= 0\\     
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{/home/aryan/GVV/figs/figure1.png}
\caption{Line AB}
\label{fig:line AB}	
\end{figure}
\end{document}
