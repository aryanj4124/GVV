...
\end{align}
\begin{enumerate}
      \item when 6 heads came,
             \begin{align}
             X(\text{6H, 0T}) &= |6 - 0| \\
               &= 6
             \end{align}
      \item when 5 heads and 1 tail came,
             \begin{align}
             X(\text{5H, 1T}) &= |5 - 1| \\
               &= 4
             \end{align}
      \item when 4 heads and 2 tails came,
             \begin{align}
             X(\text{4H, 2T}) &= |4 - 2| \\
               &= 2
             \end{align}
      \item when 3 heads and 3 tails came,
             \begin{align}
             X(\text{3H, 3T}) &= |3 - 3| \\
               &= 0
             \end{align}
      \item when 2 heads and 4 tails came,
             \begin{align} 
             X(\text{2H, 4T}) &= |2 - 4| \\ 
               &= 2
             \end{align}
      \item when 1 head and 5 tails came,
             \begin{align}
             X(\text{1H, 5T}) &= |1 - 5| \\
               &= 4
             \end{align}
      \item when 6 tails came,
             \begin{align}
             X(\text{0H, 6T}) &= |0 - 6| \\
               &= 6
             \end{align}
\end{enumerate}
Therefore, $X$ is a random variable which can take the values 0, 2, 4 or 6
\end{document}
