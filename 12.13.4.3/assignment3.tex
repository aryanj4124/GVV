...
\newline
Now we will find the probability distribution of X,
\begin{align}
p_H(k) &=
        \begin{cases}
           \frac{\comb{6}{k}}{2^6}, & 0 \leq k \leq 6 \\   \label{eq:8}
           0, & k > 6
        \end{cases}
\end{align} 
\begin{align}
...
H - T &= \pm k \\
\implies 2H &= 6 \pm k \\
\implies H &= 3 \pm \frac{k}{2} 
\end{align}
So from \eqref{eq:11},
\begin{align}
p_X(k) &= P(H - T = K) \\
       &= P(H = 3 \pm \frac{k}{2}) \\ 
       &= P(H = 3 + \frac{k}{2}) + P(H = 3 - \frac{k}{2}) \\
       &= \frac{\comb{6}{3 + \frac{k}{2}}}{2^6} + \frac{\comb{6}{3 - \frac{k}{2}}}{2^6} \\ 
       &= 2(\frac{\comb{6}{3 + \frac{k}{2}}}{2^6})  
\end{align}
Therefore,
\begin{align}
p_X(k) &= 
        \begin{cases}
         \frac{\comb{6}{3 + \frac{k}{2}}}{2^6}, & k = 0 \\
         2(\frac{\comb{6}{3 + \frac{k}{2}}}{2^6}), & k = 2,4,6
        \end{cases}
\end{align}
\end{document}
