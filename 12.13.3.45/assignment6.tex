...
\pr{\text{choosing ball from bag 2}} &= \pr{\text{getting any other number on the die}} \\
                                     &= \pr{X_2} \\
                                     &= \frac{2}{3}\\
\pr{\text{choosing black ball from bag 1}} &= \pr{\left. Y_1 \right| {X_1}} \\
                                          &= \frac{3}{7} \\
\pr{\text{choosing black ball from bag 2}} &= \pr{\left. Y_1 \right| {X_2}} \\
                                          &= \frac{4}{7}     
\end{align}
So the required probability will be:
\begin{align}
\pr{\text{getting a black ball}} &= \pr{X_1} \times \pr{\left. Y_1 \right| {X_1}} + \pr{X_2} \times \pr{\left. Y_1 \right| {X_2}} \\
