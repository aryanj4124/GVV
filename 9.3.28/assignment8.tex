...
\begin{align}
	...
	\implies F_Y(y) &= 1 - Q\brak{\frac{y-\mu}{\sigma}} \label{eq:9.3.28.1}
\end{align}
The probabbility of winning the prize atleast once is given by:

Considering 0.5 as the correction term,
\begin{align}
\pr{Y > 0.5} &= 1 - F_Y\brak{0.5} \\
             &= Q\brak{\frac{0.5-\mu}{\sigma}} \quad from \eqref{eq:9.3.28.1}\\
             &= Q\brak{0} \\
             &= 0.5
\end{align}
\item \textbf{using Gaussian}
