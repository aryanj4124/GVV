...
\begin{align}
p_Y\brak{x} &= \frac{1}{\sqrt{2\pi{\sigma}^2}} e^{-\frac{\brak{x-\mu}^2}{2{\sigma}^2}} \quad \brak{x \in Y} \label{eq:9/3/28/1}
\end{align}
the Q-function from the gaussian distribution:
\begin{align}
Q\brak{x} &= \int_{x}^{\infty} p_Y\brak{t}dt  \\   
          &= \int_{x}^{\infty}\frac{1}{\sqrt{2\pi{\sigma}^2}} e^{-\frac{\brak{t-\mu}^2}{2{\sigma}^2}}dt \quad from \eqref{eq:9/3/28/1}
\end{align}
The CDF of Y is given by:
\begin{align}
F_Y\brak{x} &= \int_{-\infty}^{x} P_Y\brak{t}dt \\
            &= 1 - \int_{x}^{\infty} P_Y\brak{t}dt \\
            &= 1 - Q\brak{x}   \label{eq:9/3/28/2}
\end{align}
The probabbility of winning the prize atleast once is given by:
\begin{align}
\pr{Y \geq 1} &= 1 - F_Y\brak{0} \\
              &= Q\brak{0}   \quad from \eqref{eq:9/3/28/2} \\
              &= 0.5
\end{align}
\item \textbf{using Gaussian}
...
\begin{align}
p_Y\brak{1} &= \frac{1}{\sqrt{2\pi{\sigma}^2}} e^{-\frac{\brak{1-\mu}^2}{2{\sigma}^2}} \quad from \eqref{eq:9/3/28/1} \\
            &= 0.44
\end{align}
\item \textbf{using Gaussian}
...
\begin{align}
\pr{Y \geq 2} &= 1 - F_Y\brak{1} \\
              &= Q\brak{1}  \quad from \eqref{eq:9/3/28/2} \\
              &= 0.158
\end{align}
\end{enumerate}
